...
class CheckUpdateTask extends AsyncTask<Void, Void, String> {
     ...
     * Show dialog
     */
    private void showDialog(Context context, String content, String apkUrl, boolean isMaskShow) {
        if(isMaskShow){
            UpdateDialog.maskshow(context, content, apkUrl);
        }else{
     ...
     * Show Notification
     */
    private void showNotification(Context context, String content, String apkUrl, boolean isMaskShow) {
